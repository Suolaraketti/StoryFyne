...
"""
PORTRAIT_CSS=r"""
body.p .ev{padding:0 5%}
body.p .line{font-size:78px}body.p .line.big{font-size:106px}body.p .line.sm{font-size:60px}
body.p .typed{font-size:48px}
body.p .srow span{font-size:60px}
body.p .k-title{font-size:58px}body.p .kicker{margin-bottom:30px}
body.p .b-logo{height:96px}body.p .b-sub{font-size:34px}
body.p .metcard{padding:36px 44px}body.p .met-v{font-size:116px}body.p .met-d{font-size:32px}
body.p .born{width:320px;height:320px}body.p .node{width:104px;height:104px}
body.p .ring.r1{width:180px;height:180px}body.p .ring.r2{width:250px;height:250px}
body.p .cta-title{font-size:62px}body.p .cta-url{font-size:28px}
...
<title>Dialfyne — Story</title><script src="assets/gsap.min.js"></script><style>__CSS__</style></head><body class="__BODYCLASS__">
